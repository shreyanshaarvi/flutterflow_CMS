...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF5D50F0);
  late Color secondary = const Color(0xFF2515F0);
  late Color tertiary = const Color(0xFFFF8C23);
  ...
  late Color error = const Color(0xFFFF0011);
  late Color info = const Color(0xFFFFFFFF);

  late Color borderColor = const Color(0xFFE3E3E3);
}
